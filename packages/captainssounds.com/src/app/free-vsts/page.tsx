...
export const metadata = {
  title: 'Free VSTs',
  description: 'A list of free VSTs that are worth having in every arsenal',
  openGraph: {
    publishedTime: '2022-02-01T00:00:00Z',
    modifiedTime: '2022-02-01T00:00:00Z',
    type: 'article'
  }
}
...
export default function Page() {
  return (
    <PageContainer className="text-left">
      <h3>
        These VSTs are worth having in every arsenal, despite being FREE.
        I&lsquo;ve left out a few that I use because Ableton has better internal
        options
      </h3>
      <p>
        <br />
        <strong>
          I&lsquo;m listing the ones I use, but here are a few good lists if
          you&lsquo;re looking for more
          <br />
        </strong>
        <a
        ...
        <br />
        <strong>
          I also recommend picking up a copy of Computer Music (online or mag),
          you will get a GIANT backlog of amazing VSTs for free!
        </strong>
        <br />
        <br />
        ...
        <br />
        Free Effects, and amazing plugins
        <br />
        <br />
        <a
      ...
      <p>
        ...
        <br />
        Effects &amp; Instruments (Older plugins may require a 32bit vst bridge
        like JBridge)
        <br />
        <br />
        <a
